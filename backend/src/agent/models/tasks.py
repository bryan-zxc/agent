...
class ExecutionPlanModel(BaseModel):
    ...
    todos: list[TodoItem] = Field(
        ...
        "Can be empty if there are no more todos, for example when the answer template is completely filled out. "
        "Make the list succinct - meaning all required actions to get remaining information should be done, but don't break actions that can be done in one step into multiple unnecessarily, nor create filler tasks."
    )
